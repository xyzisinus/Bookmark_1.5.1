...
#define SHKMyAppName			@"Bookmark"
#define SHKMyAppURL				@"http://bookmarkapp.com"
...
#define SHKFacebookKey				@"104330329627812"
#define SHKFacebookSecret			@"e33c54ed4f3264d39327d76a08ae8cbd"
 ...
 */
#define SHKTwitterConsumerKey		@"Ot7CBe2AAEJTgDHCTWMg"
#define SHKTwitterSecret			@"1rZV2UKOu6OrWxEYSmNgbEecPh1fHZu9FuezRgJhIo"
#define SHKTwitterCallbackUrl		@"http://bookmarkapp.com/tw_done" // You need to set this if using OAuth, see note above (xAuth users can skip it)
